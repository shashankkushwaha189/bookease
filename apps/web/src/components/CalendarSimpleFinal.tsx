...
const CalendarSimple: React.FC = () => {
  ...
  const renderDay = (dayInfo: any) => {
    ...
    return (
      <div
        className={`relative h-20 border border-gray-200 p-1 cursor-pointer ${!isCurrentMonth ? 'bg-gray-50' : 'bg-white'} ${isToday ? 'ring-2 ring-blue-500' : ''} hover:bg-gray-100 transition-colors`}
