...
class MFAController {
     ...
     */
    generateSMSCode = async (req, res, next) => {
        try {
     ...
     * Verify SMS code
     */
    verifySMSCode = async (req, res, next) => {
        try {
     ...
     */
    sendEmailVerificationCode = async (req, res, next) => {
        try {
     ...
     */
    generateRecoveryCodes = async (req, res, next) => {
        try {
            const { userId } = req.params;
            if (!userId) {
                return res.status(400).json({
     ...
     */
    verifyRecoveryCode = async (req, res, next) => {
        try {
            const { userId, code } = req.body;
     ...
     * Check MFA status
     */
    getMFAStatus = async (req, res, next) => {
        try {
            const { userId } = req.params;
