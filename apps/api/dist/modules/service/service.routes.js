...
router.post('/', auth_middleware_1.authMiddleware, (0, role_middleware_1.requireRole)('ADMIN'), service_controller_1.serviceController.create);
router.patch('/:id', auth_middleware_1.authMiddleware, (0, role_middleware_1.requireRole)('ADMIN'), service_controller_1.serviceController.update);
router.delete('/:id', auth_middleware_1.authMiddleware, (0, role_middleware_1.requireRole)('ADMIN'), service_controller_1.serviceController.delete);
