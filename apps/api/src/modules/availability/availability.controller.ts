...
export class AvailabilityController {
    async getAvailability(req: Request, res: Response) {
        ...
        try {
            ...
            // For public requests, extract tenant ID from headers if not set by middleware
            const tenantId = req.tenantId || req.headers['x-tenant-id'] as string || "b18e0808-27d1-4253-aca9-453897585106";
