...
export class TimelineController {
    ...
    getTimeline = async (req: Request, res: Response) => {
        try {
            ...
            const result = await timelineService.getTimeline(query);
     ...
     */
    getTimelineSummary = async (req: Request, res: Response) => {
        try {
            const appointmentId = req.params.id as string;
            const tenantId = String(req.headers['x-tenant-id'] || '');
            ...
            const summary = await timelineService.getTimelineSummary(appointmentId, tenantId);
     ...
     */
    verifyImmutability = async (req: Request, res: Response) => {
        try {
            const appointmentId = req.params.id as string;
            const tenantId = String(req.headers['x-tenant-id'] || '');
            ...
            const verification = await timelineService.verifyImmutability(appointmentId, tenantId);
     ...
     */
    testPerformance = async (req: Request, res: Response) => {
        try {
            const tenantId = String(req.headers['x-tenant-id'] || '');
