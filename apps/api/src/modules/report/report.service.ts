...
export class ReportService {
    ...
    async getPeakTimes(tenantId: string, fromDate: Date, toDate: Date) {
    ...
    async getStaffUtilization(tenantId: string, fromDate: Date, toDate: Date) {
    ...
    async getExportData(tenantId: string, type: 'appointments' | 'customers', fromDate: Date, toDate: Date) {
