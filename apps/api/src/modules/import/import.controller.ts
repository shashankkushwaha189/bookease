...
import { importService, ImportResult, RowValidationReport } from './import.service';
...
export class ImportController {
     ...
     */
    validateCustomers = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const validationReport = await importService.generateValidationReport(file.buffer, 'customers');
     ...
     */
    validateServices = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const tenantId = String(req.headers['x-tenant-id'] || '');
            const file = req.file;
            ...
            const validationReport = await importService.generateValidationReport(file.buffer, 'services');
     ...
     * Validate staff CSV
     */
    validateStaff = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const tenantId = String(req.headers['x-tenant-id'] || '');
            const file = req.file;
            ...
            const validationReport = await importService.generateValidationReport(file.buffer, 'staff');
    ...
    getHistory = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            const history = await importService.getImportHistory(tenantId, limitNum);
